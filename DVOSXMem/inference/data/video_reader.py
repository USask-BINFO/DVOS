...
class VideoReader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        gt_path = path.join(self.mask_dir, frame.replace("_frame", "_mask"))
        ...
        if load_mask and path.exists(gt_path):
            ...
            mask[mask > 0] = 1                  # Change the masks to be binary
            data['mask'] = mask
        else: 
            print("Ground truth mask does not exist.")
...
# dataset = VideoReader("yellow_VID_00000", 
#             path.join("../SyntheticWheatData/checking/frames/yellow_VID_00000/"), 
#             path.join("../SyntheticWheatData/checking/masks/yellow_VID_00000/"),
#             size=384
#         )
# data = dataset[0]