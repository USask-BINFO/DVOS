...
class Configuration():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--wheat_root', help='Wheat data root', default='../SyntheticWheatData') # root + training/frames(masks)/*.png
        ...
        # Stage 2, DAVIS+YoutubeVOS, longer (For DVOS on Wheat, we used this stage for fine-tuning XMem Original model XMem-s012, Which was Trained on BL30K Data and obtained the highest performance among all of their pretrained models)
