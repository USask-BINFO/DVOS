...
class SpatialTRFMS(object):
    ...
    def __init__(self, 
        ...
        self.spatial_trfms = {
            ...
            10: A.Compose([
                A.SmallestMaxSize(max_size=self.image_size[0], interpolation=1, always_apply=True, p=1.0),    # Rescaling, keeping the aspect ratio.  
                A.CenterCrop(height=self.image_size[0], width=self.image_size[1], always_apply=True, p=1.0)
            ])
        }
